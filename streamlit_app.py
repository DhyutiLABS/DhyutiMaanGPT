...
from dhyutiMaanGPTFunctions import (
    speechtotext,
    texttospeech_raw,
...
# -------------------------------------------------------------------------#
# App title
st.set_page_config(page_title="DhyutiMaanGPT")
st.header("DhyutiMaanGPT: Inegrating brilliance into robots!")
st.title("How can I make your day brighter?")


# Hugging Face Credentials
with st.sidebar:
    st.title("DhyutiMaanGPT")
    st.success(
...
myargs = [
    "Engineered in India",
    "" "With reverence to bright minds by ",
    link("https://www.linkedin.com/in/rahul-sundar-311a6977/", "@Rahul"),
    br(),
    link("https://github.com/RahulSundar", "DhyutiMaanGPT"),
]
